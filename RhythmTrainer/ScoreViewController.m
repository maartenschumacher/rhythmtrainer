...
/*
 ...
 when user clicks play:
    highlight beat
    inform audiosampleplayer which note to play
    keep track of input
 at the end of bar:
    reset beat states and input tracking
    check input
    increase iteration/level when necessary
    get new rhythm
    update score using animation
 save/load state information
 track level and leveliteration
 ...
 set level
 configure score
 configure pointer fade
 start music, timer, and pointer animation
 
 static through different modes:
 level
 asking for rhythm
 end of bar check
 ...
 changes:
 asks for different rhythm
 geometry
 ability to disable score animation
 save rhythm into rhythminstance at level completion
